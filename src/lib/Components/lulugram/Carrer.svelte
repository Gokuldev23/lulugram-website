<main class="max-w-6xl mx-auto md:py-20 py-10 px-4">
    ...
    <div class="grid md:grid-cols-[1fr_300px] gap-10 ">
        ...
        <p class="md:text-lg/10 text-base/6 font-medium tracking-wider  md:text-left text-justify">
            ...
            excellence extends to our team, and we are constantly seeking individuals who share our values
            and vision. As a member of the Lulugram team, you will have the opportunity to collaborate with
            talented professionals who are passionate about Softwares. We value innovation and encourage our
            employees to bring fresh perspectives to the table, pushing the boundaries of what's possible..
        </p>
    </div>
</main>